...
namespace Engine
{
	...
	void EditorLayer::OnOverlayRender()
	{
		...
		if (m_ShowPhysicsColliders)
		{
			...
			// Draw Box Colliders
			{
				auto view = m_ActiveScene->GetAllEntitiesWith<TransformComponent, BoxCollider2DComponent>(entt::exclude<DisabledComponent>);
			...
			{
				auto view = m_ActiveScene->GetAllEntitiesWith<TransformComponent, CircleCollider2DComponent>(entt::exclude<DisabledComponent>);
	...
	void EditorLayer::UI_Settings()
	{
		...
		glm::vec2& values = m_ActiveScene->m_Acc;

		// Scene name
		ImGui::InputText("Scene name", &m_ActiveScene->m_SceneName);

		// selected entity heighlight color
		ImGui::ColorEdit4("Selected entity Color", glm::value_ptr(m_SelectedEntityColor));

		// Gravity. ImGui code copied from DrawVec3 function in SceneHierarchyPanel
		ImGui::Columns(2);
